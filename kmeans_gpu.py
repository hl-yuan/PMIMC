...
def initialize(X, num_clusters):
    """初始化聚类的中心点。函数接收两个参数，X是数据矩阵，num_clusters是需要聚类的簇数。"""
    """
...
"""定义了计算欧氏距离的函数pairwise_distance，用于计算两个数据矩阵data1和data2之间的欧氏距离。"""
...
"""定义了计算余弦距离的函数pairwise_cosine，用于计算两个数据矩阵data1和data2之间的余弦距离。"""
